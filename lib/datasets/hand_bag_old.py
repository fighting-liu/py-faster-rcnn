...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        self._classes = ('__background__', 'bag')
        ...
        self._json_file = '/home/liuhuawei/7000_ann_from8650.json'
        self._output_json_file = '/home/liuhuawei/detection_train_res101_1000.json'
    ...
    # ## Custom usage           
    # def index_to_fullPath_dict(self, filename):
    #     dic = {}
    ...
    def _json_to_xml(self, json_file):
        ...
        for i in xrange(len(annotations)):
            ...
            self._make_xml(abspath, img_index, bbox, save_folder, save_name)     
    ...
    def _make_xml(self, img_full_path, img_relative_path, bbox, save_folder, save_name):      
        '''
        ...
        for i in xrange(N):        
            ...
            name.appendChild(doc.createTextNode("bag"))
