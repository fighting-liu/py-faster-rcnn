...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        ############
        self._index_to_path = {}
        self._data_file = '/data/home/liuhuawei/clothing.txt'
        self._txt_to_xml(self._data_file)
        ...
        ## '_cat_name_to_id' is for json output, it's the same as '_class_to_ind' most of time.
        # self._cat_name_to_id = None
        ...
        # self._json_file = '/home/liuhuawei/1000_ann_from8650.json'
        # self._output_json_file = '/home/liuhuawei/detection_train_vgg_1000.json'
    ...
    #     self._cat_id_to_name = {dic['id']:dic['name'] for dic in categorys}
    #     self._cat_name_to_id = {dic['name']:dic['id'] for dic in categorys}
    #     self._classes = tuple(['__background__'] + [dic['name'] for dic in categorys])
    #     self._class_to_ind = dict(zip(self.classes, xrange(self.num_classes)))  
    ...
    #             self._id_to_index[img_id] = img_index
    #             self._index_to_id[img_index] = img_id    
            
    #         ## 2. make xml file with specified info   
    #         bbox = np.array([annot['bbox']])
    #         abspath = self._index_to_path[img_index]
    #         class_name = self._cat_id_to_name[category_id]
    #         save_folder = os.path.join(self._data_path, 'Annotations')
    #         save_name = img_index

    #         self._make_xml(abspath, img_index, class_name,bbox, save_folder, save_name)     
                ...
                for im_ind, index in enumerate(self.image_index):
                    ...
                    for k in xrange(dets.shape[0]):
                        ...
                        json_list.append({'image_id':self._index_to_id[index], \
                            'category_id':self._cat_name_to_id[cls], \
                            'bbox':[xmin, ymin, w, h],\
