...
class coco(imdb):
    def __init__(self, task_name, image_set, year, test=False):
        ...
        #########liu
        self._image_index_to_path = self._load_imgid_to_path_dict(self._ann_file)
        #########end
    ...
    #########liu
    def _load_imgid_to_path_dict(self, json_file):
    ...
    def _do_detection_eval(self, res_file, output_dir):
        ann_type = 'bbox'
        # ######
        # res_file = '/data/home/liuhuawei/detection/output/all_cats_test_frcnn_det.json'
        # ######
