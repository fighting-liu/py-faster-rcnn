...
def test_net(net, imdb, max_per_image=100, thresh=0.05, vis=False):
    ...
    for i in xrange(num_images):
        ...
        #             have 300 final proposals  
        #   scores: (300*21)score of each box for each class, 21 for num_class,        
        ...
        # Limit to max_per_image detections *over all classes*(all class is important here)
        if max_per_image > 0:
    ...
    ### results will be stored in ./output/faster_rcnn_end2end/voc_2007_test/detections.pkl          
