...
def get_minibatch(roidb, num_classes):
    ...
    if cfg.TRAIN.HAS_RPN:
        ...
        for im_i in xrange(num_images):
            ...
            #####******##### Batch index changs here, 
            ### if we train one image a batch, all batch index are 0
            ### if we train two images a batch, the first half are 0,
            ###     and the second half are 1
